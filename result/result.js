...
async function getData(movieID) {
    const result = await fetch(`http://www.omdbapi.com/?i=${movieID}&apikey=f5487706`); //Base URL
...
//Favourite Button
const addToFav = () =>{
    addToFavBtn.textContent = 'Added To Saved';
    //Check if movie is already added to the list
    if(favMovies.includes(movieID)){
        addToFavBtn.textContent = 'Already Added To Saved';
    }else{
