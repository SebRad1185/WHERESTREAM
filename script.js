...
async function loadMovies(searchTerm) {
    const URL = `http://www.omdbapi.com/?s=${searchTerm}&page=1&apikey=f5487706`; //Base URL
...
const loadMovieDetails = () => {
    ...
    searchListMovies.forEach(movie => {
        movie.addEventListener('click', async () => {
            ...
            //let dir = window.location.origin + "/XMDB/result/resultPage.html"; 
            let dir = window.location.origin + "/WHERESTREAM/result/resultPage.html";// Custom URL for result page
            window.location.href = "https://SebRad1185.github.io/WHERESTREAM/result/resultPage.html";
